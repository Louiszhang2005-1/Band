      ...
      <div className="container-fluid page-body-wrapper">
        ...
        <nav className="sidebar sidebar-offcanvas" id="sidebar">
          <ul className="nav">
            ...
            <li className="nav-item">
              <a className="nav-link" data-bs-toggle="collapse" href="staff"  aria-controls="form-elements">
                ...
                <div className="home-tab">
                  <div className="d-sm-flex align-items-center justify-content-between border-bottom">
                    <ul className="nav nav-tabs" role="tablist">
                      ...
                      <li className="nav-item">
                        <Link className="nav-link" id="profile-tab" href="/staff" role="tab" aria-selected="false">Registered Staff</Link>
                      </li>
                      <li className="nav-item">
                            ...
                            <div className="col-12 grid-margin stretch-card">
                              <div className="card card-rounded">
                                <div className="card-body">
                                  <div className="d-sm-flex justify-content-between align-items-start">
                                    <div>
                                      <h4 className="card-title card-title-dash">Update Tag</h4>
                                      <p className="card-subtitle card-subtitle-dash">In this page you can update information for the patient related to the bracelet.</p>
                                    </div>
                                    <div>
                                      <button className="btn btn-primary btn-lg text-white mb-0 me-0" type="button"><i className="mdi mdi-line-scan"></i>UTX-0000000</button>
                                    </div>
                                  </div>
                                </div>
                              </div>
                  ...
                  <div className="card-body">
                    ...
                    <form className="forms-sample">
                      ...
                      <div className="form-group">
                        ...
                        <input type="text" className="form-control" id="exampleInputEmail3" placeholder="Physical Appearance"/>
                      </div>
                      <div className="form-group">
                        <label>Age Range</label>
                        <input type="text" className="form-control" id="exampleInputName1" placeholder="Age Range"/>
                      </div>
                      <div className="form-group">
                        <label>Gender</label>
                      ...
                      <div className="form-group">
                        <label>Injury picture upload</label>
                        <input type="file" name="img[]" className="file-upload-default"/>
                        <div className="input-group col-xs-12">
                          <input type="text" className="form-control file-upload-info" disabled placeholder="Upload Image"/>
                          <span className="input-group-append">
                            <button className="file-upload-browse btn btn-primary text-white" type="button">Upload</button>
                          </span>
                        </div>
                      </div>
                      {/*<div className="form-group">
                      ...
                      <Link href="/" className="btn btn-primary me-2 text-white">Submit</Link>

                            ...
                            <div className="col-12 grid-margin stretch-card">
                              <div className="card card-rounded">
                                <div className="card-body">
                                  <div className="d-sm-flex justify-content-between align-items-start">
                                    <div>
                                      <h4 className="card-title card-title-dash">Registered Staff</h4>
                                      <p className="card-subtitle card-subtitle-dash">In this page you can visualize & manage the list of registered staff in the platform.</p>
                                    </div>
                                    <div>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div className="d-flex">
                                              ...
                                              <div>
                                                <h6>Ray Murphy</h6>
                                                <p>Practictioner Nurse</p>
                                              </div>
                                            </div>
                                          </td>
                                          <td>
                                            <h6>First Aid Team</h6>
                                            <p>My organization</p>
                                          </td>
                                          <td>
                                            <div>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div className="d-flex">
                                              ...
                                              <div>
                                                <h6>Luke Bailey</h6>
                                                <p>Assistant Doctor</p>
                                              </div>
                                            </div>
                                          </td>
                                          <td>
                                            <h6>Emergency Departement</h6>
                                            <p>My organization</p>
                                          </td>
                                          <td>
                                            <div>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div className="d-flex">
                                              ...
                                              <div>
                                                <h6>Maria Butler</h6>
                                                <p>Practioner Nurse</p>
                                              </div>
                                            </div>
                                          </td>
                                          <td>
                                            <h6>First Aid Department</h6>
                                            <p>My organization</p>
                                          </td>
                                          <td>
                                            <div>

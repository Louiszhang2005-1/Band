  ...
  datasets: [
    ...
    <div className="container-scroller">
     {/*} <div className="row p-0 m-0 proBanner" id="proBanner">
      ...
      <nav className="navbar default-layout col-lg-300 col-300 p-0 fixed-top d-flex align-items-top flex-row">
        <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
          ...
          <div>
            <a className="navbar-brand brand-logo" href="index.html">
              ...
              <img src="/custom/logo-project-mod.png" alt="logo" width="1500px"/>
            </a>
                ...
                <div className="home-tab">
                  <div className="d-sm-flex align-items-center justify-content-between border-bottom">
                    <ul className="nav nav-tabs" role="tablist">
                      <li className="nav-item">
                        <Link className="nav-link active ps-0" id="home-tab" href="/" role="tab" aria-controls="overview" aria-selected="true">Overview</Link>
                      </li>
                      <li className="nav-item">
                            ...
                            <div className="col-12 grid-margin stretch-card">
                              <div className="card card-rounded">
                                <div className="card-body">
                                  <div className="d-sm-flex justify-content-between align-items-start">
                                    <div>
                                      <h4 className="card-title card-title-dash">Bracelets Location Map</h4>
                                      <p className="card-subtitle card-subtitle-dash">You can visualise the real time location of the bracelets on the map below.</p>
                                    </div>
                                    <div>
                                      <button className="btn btn-primary btn-lg text-white mb-0 me-0" type="button"><i className="mdi mdi-plus"></i>See more</button>
                                    </div>
                                  </div>
<img src="/custom/map.png" width="100%" />
                                </div>
                              </div>
                            </div>
                          </div>

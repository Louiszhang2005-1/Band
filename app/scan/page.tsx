                ...
                <div className="home-tab">
                  <div className="d-sm-flex align-items-center justify-content-between border-bottom">
                    <ul className="nav nav-tabs" role="tablist">
                      ...
                      <li className="nav-item">
                        <Link className="nav-link active" id="contact-tab" href="scan" role="tab" aria-selected="false">Scan Bracelet</Link>
                      </li>
                      <li className="nav-item">
                            ...
                            <div className="col-12 grid-margin stretch-card">
                              <div className="card card-rounded">
                                <div className="card-body">
                                  <div className="d-sm-flex justify-content-between align-items-start">
                                    <div>
                                      <h4 className="card-title card-title-dash">Scan Bracelet</h4>
                                      <p className="card-subtitle card-subtitle-dash">In this page you can a bracelet to add or update the patient information.</p>
                                    </div>
                                    <div>
                                      <Link href="update-tag" className="btn btn-primary btn-lg text-white mb-0 me-0" type="button"><i className="mdi mdi-line-scan"></i>Start Scanning</Link>
                                    </div>
                                  </div>
                                  <div className="mt-5 pl-5 flex-row">
<img src="custom/network.png" className="mt-5 pl-5"/>
                                  </div>
                                </div>
                              </div>
                            </div>

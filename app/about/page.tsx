                ...
                <div className="home-tab">
                  <div className="d-sm-flex align-items-center justify-content-between border-bottom">
                    <ul className="nav nav-tabs" role="tablist">
                      ...
                      <li className="nav-item">
                        <Link className="nav-link border-0 active" id="more-tab" href="about" role="tab" aria-selected="false">About</Link>
                      </li>
                    </ul>
                    <div>
                            ...
                            <div className="col-12 grid-margin">
                              <div className="card card-rounded">
                                <div className="card-body">
                                  <div className="d-sm-flex justify-content-between align-items-start">
                                    <div>
                                      <h4 className="card-title card-title-dash">About</h4>
                                      <p className="card-subtitle card-subtitle-dash">This project is an experiment as part of UpStart Pitching competition!</p>
                                    </div>
                                  </div>
                                </div>
                              </div>
